...
TRAIN_FILE = 'data/four_or_more/CHF_COST_SPICE.txt'
#data/four_or_more/CHF_COST_SPICE.txt

#Actual testing file
TEST_FILE = 'data/four_or_more/private/CHF_COST_SPICE_TEST.txt'
#data/four_or_more/private/CHF_COST_SPICE_TEST.txt

#If file is los/cost where conversion needs to happen, the converted train file is stored as CONVERTED_TRAIN
CONVERTED_TRAIN = 'data/four_or_more/ConvertedFormat/CHF_COST_SPICE.txt'

#If file is los/cost where conversion needs to happen, the converted test file is stored as CONVERTED_TEST
CONVERTED_TEST = 'data/four_or_more/ConvertedFormat/private/CHF_COST_SPICE_TEST.txt'
